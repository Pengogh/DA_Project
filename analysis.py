...
def make_charts(final_array,entries):
    ...
    ax[1] = plt.subplots()
    ax.plt(x6, y6)
    ax.set(xlabel = 'Time of day', ylable = 'Temperature/dew point spread', title = 'May 6th temperature/dew point spread')
    ax.grid()
    ...
    ax = plt.subplots()
    ax.plt(x7, y7)
    ax.set(xlabel = 'Time of day', ylable = 'Temperature/dew point spread', title = 'May 7th temperature/dew point spread')
    ax.grid()
    ...
    ax = plt.subplots()
    ax.plt(x8, y8)
    ax.set(xlabel = 'Time of day', ylable = 'Temperature/dew point spread', title = 'May 8th temperature/dew point spread')
    ax.grid()
    ...
    ax = plt.subplots()
    ax.plt(x9, y9)
    ax.set(xlabel = 'Time of day', ylable = 'Temperature/dew point spread', title = 'May 9th temperature/dew point spread')
    ax.grid()
    ...
    ax = plt.subplots()
    ax.plt(x10, y10)
    ax.set(xlabel = 'Time of day', ylable = 'Temperature/dew point spread', title = 'May 10th temperature/dew point spread')
    ax.grid()
